...
export interface AdamERC20Interface extends utils.Interface {
  functions: {
...
export interface AdamERC20 extends BaseContract {
  setZKPRequest(requestId: number, validatorAddress: string, query: { schema: BigNumber; slotIndex: number; operator: number; value: number[]; circuitId: string; }): unknown;
  TRANSFER_REQUEST_ID(): any;
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AdamERC20Interface;
  ...
  functions: {
    ...
    updateChildChainManager(
      newChildChainManagerProxy: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
