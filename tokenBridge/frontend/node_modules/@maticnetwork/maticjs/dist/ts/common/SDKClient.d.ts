...
import { address, SendOptions } from '@maticnetwork/maticjs/dist/ts/types/Common';
export default class SDKClient extends ContractsBase {
    ...
    transferERC1155Tokens(token: address, to: address, tokenIds: (BN | string)[], values: (BN | string)[], options: SendOptions): Promise<any>;
